...
if __name__ == "__main__":
    ...
    # url = "https://directory.goodonyou.eco/categories/maternity"
    # url = "https://directory.goodonyou.eco/categories/plus-size"
    url = "https://directory.goodonyou.eco/categories/bags"
    options = Options()
